...
export default {
    ...
    mounted() {
        document.title = "Checkout | Atta's Store"

        this.cart = this.$store.state.cart

        if (this.cartTotalLength > 0) {
            this.stripe = Stripe('pk_test_51MV4iJJf6R0v8AOGcyrDVcdB8qfM9JHirg6kzkiNOOpCusmFDqTA3F6F8MKlugmqBjVzE2VGiqs2XGNJHIZZWfHR00f3uG5seN')
